    ...
    (r.m = n = [
          ...
          h =
                ...
                requestAnimationFrame(function () {
                  t.adapter.addClass(i),
                    t.adapter.isUnbounded() &&
                      (t.adapter.addClass(r), t.layoutInternal_());
                });
              }
            }),
            ...
            (f.prototype.registerDeactivationHandlers_ = function (t) {
              ...
              "keydown" === t.type
                ...
                : d.forEach(function (t) {
                    e.adapter.registerDocumentInteractionHandler(
                      t,
            ...
            (f.prototype.updateLayoutCssVars_ = function () {
              var t = f.strings,
                ...
                i = t.VAR_TOP,
                r = t.VAR_FG_SCALE;
              this.adapter.updateCssVariable(e, this.initialSize_ + "px"),
      ...
      function (t, i, e) {
        ...
        var n = 8,
          ...
          C = 9,
          E = new Map();
        E.set(n, i.KEY.BACKSPACE),
          E.set(o, i.KEY.ENTER),
          E.set(s, i.KEY.SPACEBAR),
          E.set(a, i.KEY.PAGE_UP),
          E.set(c, i.KEY.PAGE_DOWN),
          E.set(u, i.KEY.END),
          E.set(l, i.KEY.HOME),
          E.set(d, i.KEY.ARROW_LEFT),
          E.set(p, i.KEY.ARROW_UP),
          E.set(h, i.KEY.ARROW_RIGHT),
          E.set(f, i.KEY.ARROW_DOWN),
          E.set(_, i.KEY.DELETE),
          E.set(y, i.KEY.ESCAPE),
          E.set(C, i.KEY.TAB);
        var g = new Set();
        function m(t) {
          var e = t.key;
        ...
        g.add(i.KEY.PAGE_UP),
          g.add(i.KEY.PAGE_DOWN),
          g.add(i.KEY.END),
          g.add(i.KEY.HOME),
          g.add(i.KEY.ARROW_LEFT),
          g.add(i.KEY.ARROW_UP),
          g.add(i.KEY.ARROW_RIGHT),
          g.add(i.KEY.ARROW_DOWN),
          (i.normalizeKey = m),
      ...
      function (t, e, n) {
        ...
        var i, r;
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.jumpChipKeys = e.navigationKeys = e.cssClasses = e.strings = e.EventSource = e.Direction = void 0),
      ...
      function (t, e, n) {
          ...
          c =
            ...
            (E.prototype.close = function (t) {
              ...
              if ((void 0 === t && (t = !1), this.isSurfaceOpen)) {
                ...
                this.adapter.addClass(E.cssClasses.ANIMATING_CLOSED),
                  requestAnimationFrame(function () {
                    e.adapter.removeClass(E.cssClasses.OPEN),
                      e.adapter.removeClass(E.cssClasses.IS_OPEN_BELOW),
                      (e.closeAnimationEndTimerId = setTimeout(function () {
                        (e.closeAnimationEndTimerId = 0),
                          e.adapter.removeClass(E.cssClasses.ANIMATING_CLOSED),
            ...
            (E.prototype.autoposition = function () {
              ...
              var e = this.getoriginCorner(),
                ...
                r = this.hasBit(e, C.CornerBit.RIGHT) ? "right" : "left",
                ...
                l = (((t = {})[r] = o), (t[i] = s), t);
              c.width / u.width >
                C.numbers.ANCHOR_TO_MENU_SURFACE_WIDTH_RATIO && (r = "center"),
                ...
                this.hasBit(e, C.CornerBit.BOTTOM) ||
            ...
            (E.prototype.getoriginCorner = function () {
              ...
              !(
                0 <
                (e = this.hasBit(this.anchorCorner, C.CornerBit.BOTTOM)
                ...
                e < t &&
                (n = this.setBit(n, C.CornerBit.BOTTOM));
              var c,
                u,
                l = this.adapter.isRtl(),
                d = this.hasBit(this.anchorCorner, C.CornerBit.FLIP_RTL),
                p =
                  this.hasBit(this.anchorCorner, C.CornerBit.RIGHT) ||
                  this.hasBit(n, C.CornerBit.RIGHT),
                h = !1;
              u = (h = l && d ? !p : p)
              ...
              var f = 0 < c - s.width,
                _ = 0 < u - s.width,
                y =
                  this.hasBit(n, C.CornerBit.FLIP_RTL) &&
                  this.hasBit(n, C.CornerBit.RIGHT);
              return (
                (_ && y && l) || (!f && y)
                  ? (n = this.unsetBit(n, C.CornerBit.RIGHT))
                  : ((f && h && l) || (f && !h && p) || (!_ && u <= c)) &&
                    (n = this.setBit(n, C.CornerBit.RIGHT)),
                n
              );
            }),
            (E.prototype.getMenuSurfaceMaxHeight = function (t) {
              ...
              var e = this.measurements.viewportDistance,
                n = 0,
                i = this.hasBit(t, C.CornerBit.BOTTOM),
                r = this.hasBit(this.anchorCorner, C.CornerBit.BOTTOM),
            ...
            (E.prototype.getHorizontalOriginOffset = function (t) {
              var e = this.measurements.anchorSize,
                n = this.hasBit(t, C.CornerBit.RIGHT),
            ...
            (E.prototype.getVerticalOriginOffset = function (t) {
              var e = this.measurements.anchorSize,
                n = this.hasBit(t, C.CornerBit.BOTTOM),
        ...
        function E(t) {
          ...
          return (
            ...
            (e.anchorCorner = C.Corner.TOP_START),
            (e.originCorner = C.Corner.TOP_START),
      ...
      function (t, e, n) {
        ...
        var i;
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.CloseReason = e.selectors = e.events = e.numbers = e.cssClasses = void 0),
          (e.cssClasses = {
      ...
      function (t, e, n) {
        ...
        var d,
          p =
            ...
            (h.prototype.handleFocusIn = function (t) {
              this.eventFromPrimaryAction_(t) &&
            ...
            (h.prototype.handleKeydown = function (t) {
              if (!this.isEditing())
                return (
                  ...
                  this.shouldNotifyInteraction_(t)
                    ? (this.adapter.notifyInteraction(),
                      void this.setPrimaryActionFocusable_(
                        this.getFocusBehavior_()
                      ))
                    : this.isDeleteAction_(t)
                    ? (t.preventDefault(), void this.removeChip_())
                    : void (
                        u.navigationKeys.has(t.key) &&
                        (t.preventDefault(),
                        this.focusNextAction_(t.key, u.EventSource.PRIMARY))
                      )
                );
            ...
            (h.prototype.handleTrailingActionNavigation = function (t) {
              return this.focusNextAction_(
                t.detail.key,
                u.EventSource.TRAILING
              );
            }),
            ...
            (h.prototype.focusNextAction_ = function (t, e) {
              ...
              return u.jumpChipKeys.has(t) || !n
                ...
                ? this.focusPrimaryAction()
                : void this.adapter.notifyNavigation(t, u.EventSource.NONE);
            }),
            ...
            (h.prototype.shouldStartEditing = function (t) {
              return (
                this.eventFromPrimaryAction_(t) && t.key === u.strings.ENTER_KEY
              );
            }),
        ...
        function h(t) {
          ...
          return (
            (e.shouldRemoveOnTrailingIconClick_ = !0),
            (e.shouldFocusPrimaryActionOnClick_ = !0),
            e
          );
        }
      ...
      function (t, e, n) {
        ...
        var i;
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.events = e.SortValue = e.strings = e.messages = e.selectors = e.dataAttributes = e.attributes = e.cssClasses = void 0),
          (e.cssClasses = {
          ...
          l =
            ...
            (d.prototype.initialSyncWithDOM = function () {
              (this.isEvolutionEnabled =
                ...
                (this.focusInEventListener = this.handleFocusInEvent.bind(
                  this
                )),
                (this.focusOutEventListener = this.handleFocusOutEvent.bind(
                  this
                )),
            ...
            (d.prototype.getPrimaryText = function (t) {
              var e,
                n = t.querySelector(
                  "." +
                    this.classNameMap[c.cssClasses.LIST_ITEM_PRIMARY_TEXT_CLASS]
                );
            ...
            (d.prototype.initializeListType = function () {
              ...
              if (
                ...
                var t = Array.from(
                  this.root.querySelectorAll(c.strings.SELECTED_ITEM_SELECTOR),
                  function (t) {
      ...
      function (t, e, n) {
          ...
          d =
            ...
            (p.prototype.maybeInitializeSingleSelection = function () {
              for (var t = this.adapter.getListItemCount(), e = 0; e < t; e++) {
                var n = this.adapter.listItemAtIndexHasClass(
                    e,
                ...
                if (n || i)
                  return (
                    ...
                    (this.isSingleSelectionList_ = !0),
                    void (this.selectedIndex_ = e)
                  );
              }
            }),
            ...
            (p.prototype.isTypeaheadInProgress = function () {
              return (
                this.hasTypeahead && g.isTypingInProgress(this.typeaheadState)
              );
            }),
            ...
            (p.prototype.handleFocusOut = function (t, e) {
              ...
              0 <= e &&
                ...
                setTimeout(function () {
                  n.adapter.isFocusInsideList() ||
                    n.setTabindexToFirstSelectedOrFocusedItem();
                }, 0);
            }),
            (p.prototype.handleKeydown = function (t, e, n) {
              var i = this,
                r = "ArrowLeft" === y.normalizeKey(t),
                o = "ArrowUp" === y.normalizeKey(t),
                s = "ArrowRight" === y.normalizeKey(t),
                a = "ArrowDown" === y.normalizeKey(t),
                c = "Home" === y.normalizeKey(t),
                u = "End" === y.normalizeKey(t),
                l = "Enter" === y.normalizeKey(t),
                d = "Spacebar" === y.normalizeKey(t),
                p = "A" === t.key || "a" === t.key;
              if (this.adapter.isRootFocused()) {
                ...
                if (!(-1 === f && (f = n) < 0)) {
                  if ((this.isVertical_ && a) || (!this.isVertical_ && s))
                    E.preventDefaultEvent(t), this.focusNextElement(f);
                  else if ((this.isVertical_ && o) || (!this.isVertical_ && r))
                    E.preventDefaultEvent(t), this.focusPrevElement(f);
                  else if (c)
                    E.preventDefaultEvent(t), this.focusFirstElement();
                  else if (u) E.preventDefaultEvent(t), this.focusLastElement();
                  else if (p && t.ctrlKey && this.isCheckboxList_)
                    t.preventDefault(),
                      this.toggleAll(
                        this.selectedIndex_ === C.numbers.UNSET_INDEX
                          ? []
                          : this.selectedIndex_
                      );
                  else if ((l || d) && e) {
                    ...
                    this.isTypeaheadInProgress() ||
                      (this.isSelectableList_() &&
                        this.setSelectedIndexOnAction_(f),
            ...
            (p.prototype.setSingleSelectionAtIndex_ = function (t) {
              if (this.selectedIndex_ !== t) {
                ...
                this.useActivatedClass_ &&
                  (e = C.cssClasses.LIST_ITEM_ACTIVATED_CLASS),
                  this.selectedIndex_ !== C.numbers.UNSET_INDEX &&
                    this.adapter.removeClassForElementIndex(
                      this.selectedIndex_,
                      e
                  ...
                  t !== C.numbers.UNSET_INDEX &&
                    this.adapter.addClassForElementIndex(t, e),
            ...
            (p.prototype.getSelectionAttribute = function () {
              return this.useSelectedAttr_
                ? C.strings.ARIA_SELECTED
            ...
            (p.prototype.setTabindexAtIndex = function (t) {
              this.focusedItemIndex === C.numbers.UNSET_INDEX && 0 !== t
                ...
                this.selectedIndex_ instanceof Array ||
                  this.selectedIndex_ === t ||
                  this.adapter.setAttributeForElementIndex(
                    this.selectedIndex_,
                    "tabindex",
            ...
            (p.prototype.isIndexValid_ = function (t) {
              ...
              return (
                this.isIndexInRange_(t) ||
                (this.isSingleSelectionList_ && t === C.numbers.UNSET_INDEX)
              );
            }),
            ...
            (p.prototype.toggleCheckboxAtIndex_ = function (e, t) {
              ...
              t &&
                ((i = !i), this.adapter.setCheckedCheckboxOrRadioAtIndex(e, i)),
                this.adapter.setAttributeForElementIndex(
                  e,
                  n,
                  i ? "true" : "false"
            ...
            (p.prototype.toggleAll = function (t) {
              var e = this.adapter.getListItemCount();
              if (t.length === e) this.setCheckboxAtIndex_([]);
              else {
                for (var n = [], i = 0; i < e; i++)
                  (!this.adapter.listItemAtIndexHasClass(
                    i,
        ...
        function p(t) {
          ...
          return (
            ...
            (e.selectedIndex_ = C.numbers.UNSET_INDEX),
            (e.focusedItemIndex = C.numbers.UNSET_INDEX),
            (e.useActivatedClass_ = !1),
            (e.useSelectedAttr_ = !1),
            (e.ariaCurrentAttrValue_ = null),
            (e.isCheckboxList_ = !1),
            (e.isRadioList_ = !1),
            (e.hasTypeahead = !1),
            (e.typeaheadState = g.initState()),
        ...
        var s,
          ...
          u =
            ...
            (l.prototype.setValidation = function (t) {
              t
                ? this.adapter.addClass(c.cssClasses.HELPER_TEXT_VALIDATION_MSG)
      ...
      function (t, e, n) {
        ...
        var i, r;
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.PositionWithCaret = e.strings = e.YPosition = e.AnchorBoundaryType = e.XPosition = e.events = e.attributes = e.numbers = e.CssClasses = void 0),
      ...
      function (t, e, n) {
        ...
        function u(t) {
          ...
          return (
            ...
            (e.lastScrollPosition_ = e.adapter.getViewportScrollY()),
            (e.topAppBarHeight_ = e.adapter.getTopAppBarHeight()),
            e
          );
        }
      ...
      function (t, e, n) {
        ...
        function h(t) {
          ...
          return (
            (e.isOpened = !1), (e.animationFrame = 0), (e.animationTimer = 0), e
          );
        }
          ...
          y =
            ...
            (C.prototype.initialize = function () {
              ...
              (this.nativeControl_.indeterminate =
                "true" === this.nativeControl_.getAttribute(t)),
                this.nativeControl_.removeAttribute(t);
            }),
            ...
            Object.defineProperty(C.prototype, "nativeControl_", {
              get: function () {
                var t = h.strings.NATIVE_CONTROL_SELECTOR,
            ...
            (h.prototype.handleAnimationEnd = function () {
              ...
              this.enableAnimationEndHandler_ &&
                ...
                (this.animEndLatchTimer_ = setTimeout(function () {
                  t.adapter.removeClass(t.currentAnimationClass_),
          ...
          f =
            ...
            (_.prototype.initialize = function (t, e) {
              ...
              void 0 === t &&
                ...
                (this.leadingIcon_ = this.root.querySelector(
                  p.strings.LEADING_ICON_SELECTOR
                )),
                (this.checkmark_ = this.root.querySelector(
                  p.strings.CHECKMARK_SELECTOR
                )),
                (this.primaryAction_ = this.root.querySelector(
            ...
            (_.prototype.getDefaultFoundation = function () {
              var n = this,
                t = {
                  ...
                  isTrailingActionNavigable: function () {
                    return (
                      !!n.trailingAction_ && n.trailingAction_.isNavigable()
                    );
                  },
                  notifyInteraction: function () {
                    return n.emit(
      ...
      function (t, e, n) {
        ...
        var s,
          ...
          u =
            ...
            (l.prototype.init = function () {
              (this.closed = this.adapter.hasClass(c.cssClasses.CLOSED_CLASS)),
            ...
            (l.prototype.setDeterminate = function (t) {
              (this.determinate = t),
                this.determinate
                  ? (this.adapter.removeClass(c.cssClasses.INDETERMINATE_CLASS),
                ...
                t = {
                  ...
                  setBufferBarStyle: function (t, e) {
                    var n = i.root.querySelector(
                      a.MDCLinearProgressFoundation.strings.BUFFER_BAR_SELECTOR
                    );
      ...
      function (t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.animationDimensionPercentages = e.strings = e.cssClasses = void 0),
          (e.cssClasses = {
        ...
        var c,
          ...
          d =
            ...
            (p.prototype.handleSortAction = function (t) {
              for (
                var e = t.columnId, n = t.columnIndex, i = t.headerCell, r = 0;
      ...
      function (t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.areTopsMisaligned = e.isScrollAtBottom = e.isScrollAtTop = e.isScrollable = e.createFocusTrapInstance = void 0),
              ...
              var n = this,
                t = {
                  ...
                  setTransformOrigin: function (t) {
                    var e =
                      u.getCorrectPropertyName(window, "transform") + "-origin";
              ...
              var i = this,
                t = {
                  ...
                  notifySelected: function (t) {
                    return i.emit(h.strings.SELECTED_EVENT, {
                      index: t.index,
                  ...
                  focusListRoot: function () {
                    return i.root
                      .querySelector(h.strings.LIST_SELECTOR)
                      .focus();
                  },
          ...
          d =
            ...
            (p.prototype.handleKeydown = function (t) {
              if (
                ...
                if (
                  ...
                  return (
                    0 <= s && this.setSelectedIndex(s), void t.preventDefault()
                  );
                }
                (e || n || i || r) &&
                  (i && 0 < this.getSelectedIndex()
            ...
            (p.prototype.init = function () {
              ...
              t &&
                ...
                this.setDisabled(this.adapter.hasClass(l.cssClasses.DISABLED)),
              ...
              this.savedTabIndex_ &&
                (t
                  ...
                  : (this.adapter.setAttr("tabindex", this.savedTabIndex_),
                    this.adapter.setAttr("role", c.strings.ICON_ROLE)));
            }),
        ...
        var u,
          ...
          f =
            ...
            (_.prototype.init = function () {
              var t = this;
              (this.isDisabled = this.adapter.hasClass(c.cssClasses.DISABLED)),
                (this.isDiscrete = this.adapter.hasClass(
                  c.cssClasses.DISCRETE
                )),
                (this.hasTickMarks = this.adapter.hasClass(
                  c.cssClasses.TICK_MARKS
                )),
                (this.isRange = this.adapter.hasClass(c.cssClasses.RANGE));
              var e = this.convertAttributeValueToNumber(
                  this.adapter.getInputAttribute(
                    c.attributes.INPUT_MIN,
              ...
              this.validateProperties({
                ...
                (this.valueStart = r),
                (this.step = s),
                (this.numDecimalPlaces = (function (t) {
                ...
                (this.mousedownOrTouchstartListener = this.handleMousedownOrTouchstart.bind(
                  this
                )),
                (this.moveListener = this.handleMove.bind(this)),
                (this.pointerdownListener = this.handlePointerdown.bind(this)),
                (this.pointerupListener = this.handlePointerup.bind(this)),
                (this.thumbMouseenterListener = this.handleThumbMouseenter.bind(
                  this
                )),
                (this.thumbMouseleaveListener = this.handleThumbMouseleave.bind(
                  this
                )),
            ...
            (_.prototype.handleUp = function () {
              if (!this.isDisabled && null !== this.thumb) {
                var t =
                  ...
                  e =
                    this.thumb === p.Thumb.START ? this.valueStart : this.value;
            ...
            (_.prototype.handleThumbMouseenter = function () {
              this.isDiscrete &&
                ...
                (this.adapter.addThumbClass(
                  c.cssClasses.THUMB_WITH_INDICATOR,
                  p.Thumb.START
                ),
                this.adapter.addThumbClass(
                  c.cssClasses.THUMB_WITH_INDICATOR,
            ...
            (_.prototype.handleInputFocus = function (t) {
              if (
                (this.adapter.addThumbClass(c.cssClasses.THUMB_FOCUSED, t),
                this.isDiscrete &&
                  (this.adapter.addThumbClass(
                    c.cssClasses.THUMB_WITH_INDICATOR,
                    t
            ...
            (_.prototype.handleInputBlur = function (t) {
              if (
                (this.adapter.removeThumbClass(c.cssClasses.THUMB_FOCUSED, t),
                this.isDiscrete &&
                  (this.adapter.removeThumbClass(
                    c.cssClasses.THUMB_WITH_INDICATOR,
                    t
            ...
            (_.prototype.clampValue = function (t, e) {
              return (
                ...
                this.isRange && e === p.Thumb.START && t > this.value
                  ? this.value
                  : this.isRange && e === p.Thumb.END && t < this.valueStart
                  ? this.valueStart
                  : t
              );
            }),
                ...
                this.animFrame.request(l.SLIDER_UPDATE, function () {
                  (!s && n === p.Thumb.START) || (s && n !== p.Thumb.START)
                    ? (i.adapter.setTrackActiveStyleProperty(
                      ...
                      i.adapter.setTrackActiveStyleProperty("left", "unset"),
                      i.adapter.setTrackActiveStyleProperty(
                        "right",
                        i.rect.width - u + "px"
                      ))
                    : (i.adapter.setTrackActiveStyleProperty(
                      ...
                      i.adapter.setTrackActiveStyleProperty("right", "unset"),
                      i.adapter.setTrackActiveStyleProperty("left", c + "px")),
                    i.adapter.setTrackActiveStyleProperty(
                      a,
                      "scaleX(" + r + ")"
                    );
          ...
          d =
            ...
            (p.prototype.init = function () {
              ...
              this.adapter.hasLabel() &&
                ...
                (this.validationObserver_ = this.adapter.registerValidationAttributeChangeHandler(
            ...
            (p.prototype.handleValidationAttributeChange = function (t) {
              ...
              t.some(function (t) {
                return (
                  ...
                  (e.styleValidity_(!0),
                  e.adapter.setLabelRequired(e.getNativeInput_().required),
                  !0)
                );
              }),
            ...
            (p.prototype.styleValidity_ = function (t) {
              ...
              if (
                ...
                if (
                  ...
                  return;
                var n = this.helperText_.isVisible(),
                  i = this.helperText_.getId();
                n && i
      ...
      function (t, e, n) {
        ...
        var s,
          ...
          d = n(41),
          p = d.CssClasses.RICH,
          f = d.CssClasses.SHOWN,
          _ = d.CssClasses.SHOWING,
          y = d.CssClasses.SHOWING_TRANSITION,
          C = d.CssClasses.HIDE,
          E = d.CssClasses.HIDE_TRANSITION,
          g = d.CssClasses.MULTILINE_TOOLTIP;
        ...
        var m,
          ...
          T =
            ...
            (b.prototype.init = function () {
              (this.richTooltip = this.adapter.hasClass(p)),
                (this.persistentTooltip =
                  "true" ===
                  this.adapter.getAttribute(d.attributes.PERSISTENT)),
                (this.interactiveTooltip =
                  !!this.adapter.getAnchorAttribute(
                    d.attributes.ARIA_EXPANDED
                  ) &&
                  "dialog" ===
                    this.adapter.getAnchorAttribute(
                      d.attributes.ARIA_HASPOPUP
                    )),
                (this.hasCaret =
                  this.richTooltip &&
                  "true" === this.adapter.getAttribute(d.attributes.HAS_CARET));
            }),
            ...
            (b.prototype.show = function () {
              ...
              if (
                ...
                (this.tooltipShown = !0),
                  this.parseShowTooltipOptions().hideFromScreenreader ||
                  ...
                  this.adapter.addClass(_),
                  this.isTooltipMultiline() &&
                    !this.richTooltip &&
                    this.adapter.addClass(g),
                ...
                try {
                  for (
                    var i = u(this.addAncestorScrollEventListeners),
                      r = i.next();
                    !r.done;
                    r = i.next()
                  )
            ...
            (b.prototype.hide = function () {
              ...
              if (
                ...
                try {
                  for (
                    var n = u(this.removeAncestorScrollEventListeners),
                      i = n.next();
                    !i.done;
                    i = n.next()
                  )
            ...
            (b.prototype.setAnchorBoundaryType = function (t) {
              t === d.AnchorBoundaryType.UNBOUNDED
                ? (this.anchorGap = d.numbers.UNBOUNDED_ANCHOR_GAP)
                : (this.anchorGap = d.numbers.BOUNDED_ANCHOR_GAP);
            }),
            (b.prototype.parseShowTooltipOptions = function () {
              return {
                hideFromScreenreader: Boolean(
                  this.adapter.getAnchorAttribute("data-tooltip-id")
                ),
              };
            }),
            (b.prototype.isTooltipMultiline = function () {
              ...
              return (
                t.height > d.numbers.MIN_HEIGHT &&
                t.width >= d.numbers.MAX_WIDTH
              );
            }),
            (b.prototype.positionPlainTooltip = function () {
              var t = this.calculateTooltipStyles(this.anchorRect),
                ...
                o = v
                  ...
                  : "transform";
              this.adapter.setSurfaceStyleProperty(o + "-origin", n + " " + r),
            ...
            (b.prototype.positionRichTooltip = function () {
              ...
              var o = this.calculateTooltipStyles(this.anchorRect),
                s = o.top,
            ...
            (b.prototype.calculateXTooltipDistance = function (t, e) {
              ...
              s = this.richTooltip
                ? ((n = a ? t.left - e : t.right),
                  ...
                  (o = a ? d.strings.RIGHT : d.strings.LEFT),
                  a ? d.strings.LEFT : d.strings.RIGHT)
                : ((n = a ? t.left : t.right - e),
                  (i = a ? t.right - e : t.left),
                  (r = t.left + (t.width - e) / 2),
                  (o = a ? d.strings.LEFT : d.strings.RIGHT),
                  a ? d.strings.RIGHT : d.strings.LEFT);
              var c = this.richTooltip
                ? this.determineValidPositionOptions(n, i)
                : this.determineValidPositionOptions(r, n, i);
              if (this.xTooltipPos === d.XPosition.START && c.has(n))
                return { distance: n, xTransformOrigin: o };
              if (this.xTooltipPos === d.XPosition.END && c.has(i))
                return { distance: i, xTransformOrigin: s };
              if (this.xTooltipPos === d.XPosition.CENTER && c.has(r))
                return { distance: r, xTransformOrigin: d.strings.CENTER };
            ...
            (b.prototype.calculateYTooltipDistance = function (t, e) {
              ...
              return this.yTooltipPos === d.YPosition.ABOVE && r.has(i)
                ? { distance: i, yTransformOrigin: d.strings.BOTTOM }
            ...
            (b.prototype.setCaretPositionStyles = function (t) {
              ...
              return e
                ? (this.adapter.clearTooltipCaretStyles(),
                  this.adapter.setTooltipCaretStyle(e.yAlignment, e.yAxisPx),
                  this.adapter.setTooltipCaretStyle(e.xAlignment, e.xAxisPx),
                  ...
                  this.adapter.setTooltipCaretStyle(
                    "transform-origin",
                    e.yAlignment + " " + e.xAlignment
                  ),
                  { yTransformOrigin: e.yAxisPx, xTransformOrigin: e.xAxisPx })
                : { yTransformOrigin: 0, xTransformOrigin: 0 };
            }),
            (b.prototype.calculateCaretPositionOnTooltip = function (t) {
              var e = !this.adapter.isRTL(),
                n = this.adapter.getComputedStyleProperty("width"),
                i = this.adapter.getComputedStyleProperty("height"),
                r = this.adapter.getTooltipCaretSize();
              if (n && i && r) {
                var o = r.width * Math.sqrt(2),
                  s = "calc((" + n + " - " + o + "px) / 2)",
                  a = "calc((" + i + " - " + o + "px) / 2)",
                  c = d.numbers.CARET_INDENTATION + "px",
                  u = "45deg",
                  l = "-45deg";
                switch (t) {
        ...
        function b(t) {
          ...
          return (
            (e.tooltipShown = !1),
            (e.anchorGap = d.numbers.BOUNDED_ANCHOR_GAP),
            (e.xTooltipPos = d.XPosition.DETECTED),
            (e.yTooltipPos = d.YPosition.DETECTED),
            (e.tooltipPositionWithCaret = d.PositionWithCaret.DETECTED),
            (e.minViewportTooltipThreshold =
              d.numbers.MIN_VIEWPORT_TOOLTIP_THRESHOLD),
            (e.hideDelayMs = d.numbers.HIDE_DELAY_MS),
            (e.showDelayMs = d.numbers.SHOW_DELAY_MS),
            (e.anchorRect = null),
            (e.parentRect = null),
            (e.frameId = null),
            (e.hideTimeout = null),
          ...
          c =
            ...
            (u.prototype.handleTargetScroll = function () {
              this.adapter.getViewportScrollY() <= 0
                ? this.wasScrolled_ &&
                  (this.adapter.removeClass(s.cssClasses.FIXED_SCROLLED_CLASS),
                  (this.wasScrolled_ = !1))
                : this.wasScrolled_ ||
      ...
      function (t, e, n) {
        ...
        (e.topAppBar = B),
          ...
          a.default.register("MDCDrawer", y.MDCDrawer),
          a.default.register("MDCFloatingLabel", C.MDCFloatingLabel),
          a.default.register("MDCFormField", E.MDCFormField),
          a.default.register("MDCIconButtonToggle", g.MDCIconButtonToggle),
          ...
          d =
            ...
            (p.prototype.initialize = function (t) {
              ...
              void 0 === t &&
                ...
                (this.contentEl = this.root.querySelector(u.selectors.CONTENT)),
      ...
      function (t, e, n) {
        ...
        var o,
          ...
          y = l.MDCChipSetFoundation.strings.CHIP_SELECTOR,
          C = 0,
          E =
            ((o = s.MDCComponent),
            r(g, o),
            ...
            (g.prototype.initialSyncWithDOM = function () {
              ...
              this.chips_.forEach(function (t) {
                ...
                this.listen(p, this.handleChipInteraction_),
                this.listen(h, this.handleChipSelection_),
                this.listen(f, this.handleChipRemoval_),
                this.listen(_, this.handleChipNavigation_);
            }),
            (g.prototype.destroy = function () {
              this.chips_.forEach(function (t) {
                t.destroy();
              }),
                this.unlisten(p, this.handleChipInteraction_),
                this.unlisten(h, this.handleChipSelection_),
                this.unlisten(f, this.handleChipRemoval_),
                this.unlisten(_, this.handleChipNavigation_),
                o.prototype.destroy.call(this);
            }),
            (g.prototype.addChip = function (t) {
              (t.id = t.id || "mdc-chip-" + ++C),
            ...
            (g.prototype.instantiateChips_ = function (e) {
              return [].slice
                .call(this.root.querySelectorAll(y))
                .map(function (t) {
      ...
      function (t, n, e) {
        ...
        Object.defineProperty(n, "__esModule", { value: !0 }),
          (n.announce = n.DATA_MDC_DOM_ANNOUNCE = n.AnnouncerPriority = void 0),
          ((i = r = n.AnnouncerPriority || (n.AnnouncerPriority = {})).POLITE =
            "polite"),
          (i.ASSERTIVE = "assertive"),
          (n.DATA_MDC_DOM_ANNOUNCE = "data-mdc-dom-announce"),
          (n.announce = function (t, e) {
        ...
        var o =
          ...
          (s.prototype.createLiveRegion = function (t) {
            ...
            return (
              ...
              e.setAttribute(n.DATA_MDC_DOM_ANNOUNCE, "true"),
      ...
      function (t, e, n) {
        ...
        var u,
          ...
          f = n(60),
          _ = a(n(59)),
          y = f.MDCDialogFoundation.strings,
          C =
            ((u = l.MDCComponent),
            r(E, u),
              ...
              if (!i)
                throw new Error(
                  "Dialog component requires a " +
                    y.CONTAINER_SELECTOR +
                    " container element"
                );
              (this.container = i),
                (this.content = this.root.querySelector(y.CONTENT_SELECTOR)),
                (this.buttons = [].slice.call(
                  this.root.querySelectorAll(y.BUTTON_SELECTOR)
                )),
                (this.defaultButton = this.root.querySelector(
                  "[" + y.BUTTON_DEFAULT_ATTRIBUTE + "]"
                )),
                (this.focusTrapFactory = t),
                (this.buttonRipples = []);
              try {
            ...
            (E.prototype.initialSyncWithDOM = function () {
              ...
              (this.focusTrap = _.createFocusTrapInstance(
                ...
                this.listen("click", this.handleClick),
                this.listen("keydown", this.handleKeydown),
                this.listen(y.OPENING_EVENT, this.handleOpening),
                this.listen(y.CLOSING_EVENT, this.handleClosing);
            }),
            (E.prototype.destroy = function () {
              this.unlisten("click", this.handleClick),
                this.unlisten("keydown", this.handleKeydown),
                this.unlisten(y.OPENING_EVENT, this.handleOpening),
                this.unlisten(y.CLOSING_EVENT, this.handleClosing),
                this.handleClosing(),
      ...
      function (t, e, n) {
        ...
        var c,
          ...
          h = n(65),
          f = a(n(62)),
          _ = p.MDCDismissibleDrawerFoundation.cssClasses,
          ...
          C =
            ...
            (E.prototype.initialSyncWithDOM = function () {
              var e = this,
                t = _.MODAL,
                n = y.SCRIM_SELECTOR;
              (this.scrim_ = this.root.parentNode.querySelector(n)),
                this.scrim_ &&
                ...
                t = {
                  ...
                  focusActiveNavigationItem: function () {
                    var t = e.root.querySelector(
                      y.LIST_ITEM_ACTIVATED_SELECTOR
                    );
                    t && t.focus();
                  },
                  notifyClose: function () {
        ...
        (e.initState = function () {
          ...
          (e.handleKeydown = function (t, e) {
            var n = t.event,
              ...
              c = "ArrowLeft" === y.normalizeKey(n),
              u = "ArrowUp" === y.normalizeKey(n),
              l = "ArrowRight" === y.normalizeKey(n),
              d = "ArrowDown" === y.normalizeKey(n),
              p = "Home" === y.normalizeKey(n),
              h = "End" === y.normalizeKey(n),
              f = "Enter" === y.normalizeKey(n),
              _ = "Spacebar" === y.normalizeKey(n);
            return n.ctrlKey || n.metaKey || c || u || l || d || p || h || f
              ? -1
              : _ || 1 !== n.key.length
              ? _
                ? (i && C.preventDefaultEvent(n),
                  i && g(e)
                    ? E(
                        {
                          focusItemAtIndex: o,
          ...
          l =
            ...
            (d.prototype.initialize = function (t) {
              void 0 === t &&
                ...
                (this.segments_ = this.instantiateSegments(
                  this.segmentFactory
                ));
            }),
            (d.prototype.instantiateSegments = function (e) {
              return [].slice
                .call(this.root.querySelectorAll(c.selectors.SEGMENT))
                .map(function (t) {
                  return e(t);
                });
            }),
            (d.prototype.initialSyncWithDOM = function () {
              ...
              if (n && 0 == t.length && 0 < this.segments_.length)
                throw new Error(
            ...
            (d.prototype.destroy = function () {
              this.segments_.forEach(function (t) {
                ...
                this.unlisten(c.events.SELECTED, this.handleSelected),
                o.prototype.destroy.call(this);
            }),
            (d.prototype.getDefaultFoundation = function () {
              var n = this,
          ...
          b =
            ...
            (A.prototype.initialize = function (t, e, n, i, r, o) {
              if (
                ...
                (this.selectAnchor = this.root.querySelector(
                  g.strings.SELECT_ANCHOR_SELECTOR
                )),
                (this.selectedText = this.root.querySelector(
                  g.strings.SELECTED_TEXT_SELECTOR
                )),
                (this.hiddenInput = this.root.querySelector(
                  g.strings.HIDDEN_INPUT_SELECTOR
                )),
                !this.selectedText)
              )
                throw new Error(
              ...
              if (this.selectAnchor.hasAttribute(g.strings.ARIA_CONTROLS)) {
                var s = document.getElementById(
                  this.selectAnchor.getAttribute(g.strings.ARIA_CONTROLS)
                );
              ...
              l && (this.leadingIcon = r(l)),
                this.root.classList.contains(g.cssClasses.OUTLINED) ||
            ...
            (A.prototype.initialSyncWithDOM = function () {
              ...
              if (
                ...
                this.menu.listen(h.strings.CLOSED_EVENT, this.handleMenuClosed),
                this.menu.listen(
                  h.strings.CLOSING_EVENT,
                  this.handleMenuClosing
                ),
                this.menu.listen(h.strings.OPENED_EVENT, this.handleMenuOpened),
                this.menu.listen(
            ...
            (A.prototype.createRipple = function () {
              var n = this,
                t = o(
                  o({}, C.MDCRipple.createAdapter({ root: this.selectAnchor })),
                  {
                    registerInteractionHandler: function (t, e) {
              ...
              return new C.MDCRipple(
                this.selectAnchor,
                new E.MDCRippleFoundation(t)
              );
            }),
                  ...
                  updateTickMarks: function (t) {
                    ...
                    e ||
                      ...
                      t.length !== e.children.length
                        ? ((e.innerHTML = ""), i.addTickMarks(e, t))
                        : i.updateTickMarks(e, t);
                  },
      ...
      function (t, e, n) {
        ...
        var c,
          ...
          _ = d.strings.LABEL_SELECTOR,
          y = d.strings.ACTION_SELECTOR,
          C = d.strings.DISMISS_SELECTOR,
          E = d.strings.OPENING_EVENT,
          g = d.strings.OPENED_EVENT,
          ...
          T =
            ...
            (b.prototype.initialSyncWithDOM = function () {
              var n = this;
              (this.surfaceEl_ = this.root.querySelector(f)),
                (this.labelEl_ = this.root.querySelector(_)),
                (this.actionEl_ = this.root.querySelector(y)),
                (this.handleKeyDown_ = function (t) {
          ...
          _ =
            ...
            (y.prototype.initialize = function (t, e, n, i, r, o, s) {
              ...
              var f = b.MDCTextFieldCharacterCounterFoundation.strings,
                _ = this.root.querySelector(f.ROOT_SELECTOR);
              !_ && p && d && (_ = d.querySelector(f.ROOT_SELECTOR)),
                (this.characterCounter_ = _ ? i(_) : null);
              ...
              (this.trailingIcon_ = C ? r(C) : null),
                (this.prefix_ = this.root.querySelector(
                  A.strings.PREFIX_SELECTOR
                )),
                (this.suffix_ = this.root.querySelector(
            ...
            (y.prototype.getFoundationMap_ = function () {
              return {
                ...
                helperText: this.helperText_
                  ? this.helperText_.foundationForTextField
                  : void 0,
          ...
          p =
            ...
            (h.prototype.initialize = function (n) {
              void 0 === n &&
                ...
                (this.navIcon_ = this.root.querySelector(
                  c.strings.NAVIGATION_ICON_SELECTOR
                ));
              var t = [].slice.call(
                this.root.querySelectorAll(c.strings.ACTION_ITEM_SELECTOR)
              );
            ...
            (h.prototype.initialSyncWithDOM = function () {
              (this.handleNavigationClick_ = this.foundation.handleNavigationClick.bind(
                this.foundation
              )),
                (this.handleWindowResize_ = this.foundation.handleWindowResize.bind(
                  this.foundation
                )),
              ...
              this.root.classList.contains(c.cssClasses.SHORT_CLASS) ||
                t ||
            ...
            (h.prototype.getDefaultFoundation = function () {
              ...
              return this.root.classList.contains(c.cssClasses.SHORT_CLASS)
                ? new l.MDCShortTopAppBarFoundation(t)
                : this.root.classList.contains(c.cssClasses.FIXED_CLASS)
