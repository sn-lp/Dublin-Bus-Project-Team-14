  ...
  return (
    (n = [
      ...
      function (t, e, n) {
        ...
        var i = n(8),
          ...
          at = function (t) {
            ...
            return (
              !(this === V && d(J, e) && !d(tt, e)) &&
              (!(t || !d(this, e) || !d(J, e) || (d(this, W) && this[W][e])) ||
                t)
            );
          },
          c = function (t, e) {
            ...
            if (n !== V || !d(J, t) || d(tt, t)) {
              e = X(n, t);
              return (
                !e || !d(J, t) || (d(n, W) && n[W][t]) || (e.enumerable = !0), e
              );
            }
          },
          f = function (t) {
      ...
      function (t, e, n) {
        ...
        r(
          { target: "Array", proto: !0, forced: v || !n || !i || !g },
          {
            sort: function (t) {
              void 0 !== t && a(t);
              var e = u(this);
      ...
      function (t, e, n) {
            ...
            off: function (c, a, t, e) {
              if ("string" == typeof a && c) {
                var n = y(S(a, t, e), 3),
                  ...
                  n = "." === a.charAt(0);
                if (void 0 !== e)
                  return u && u[o] ? void x(c, u, o, e, r ? t : null) : void 0;
                n &&
                  Object.keys(u).forEach(function (t) {
                    ...
                    (e = c),
                      ...
                      Object.keys(i).forEach(function (t) {
                        -1 < t.indexOf(o) &&
                          ((t = i[t]),
                          x(e, n, r, t.originalHandler, t.delegationSelector));
                      });
                  });
                var s = u[o] || {};
        ...
        Tt.on(document, Ht, '[data-mdb-toggle="offcanvas"]', function (t) {
          ...
          ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
            Z(this) ||
              ...
              (t = W.findOne(ln)) && t !== n && mn.getInstance(t).hide(),
          ...
          gr = (function () {
            ...
            function i(t, e) {
              return (
                ...
                (t._indicatorsElement = W.findOne(vr, t._element)),
                (t._touchSupported =
        ...
        Tt.on(
          ...
          Tt.on(window, Ht, function () {
            for (
              var t = W.find('[data-mdb-ride="carousel"]'), e = 0, n = t.length;
              e < n;
              e++
            )
          ...
          ro = (function () {
            ...
            function o(t, e) {
              return (
                ...
                ((t = r.call(this, t))._config = t._getConfig(e)),
                (t._dialog = W.findOne(no, t._element)),
                (t._backdrop = t._initializeBackDrop()),
                (t._isShown = !1),
              ...
              (e = [
                ...
                },
                {
                  ...
                  value: function (t) {
                    return (
                      (t = Dr(
                        Dr(Dr({}, Wr), fe.getDataAttributes(this._element)),
                        t
                      )),
                      K("modal", t, Fr),
                      t
        ...
        var Ki = Xi(),
          Gi = Xi({ defaultModifiers: [Ei, zi, wi, ti, Fi, Hi, Qi, mi, Wi] }),
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    (e = this._initializeOnDelegatedTarget(t, e)),
                      t &&
                        (e._activeTrigger["focusin" === t.type ? xc : Pc] = !0),
                  ...
                  value: function (t) {
                    ...
                    return (
                      "string" !=
                        ...
                        $(t.target) &&
                        ((e = t.target.id) || ((e = z(ga)), (t.target.id = e)),
                        (t.target = "#".concat(e))),
                      K(ga, t, _a),
                      t
                    );
                  ...
                  value: function (e) {
                    ...
                    t.classList.contains(Ea)
                      ? (W.findOne(
                        ...
                        t.classList.add(ka))
                      : (t.classList.add(ka),
                        W.parents(t, ".nav, .list-group").forEach(function (t) {
                          W.prev(t, "".concat(ja, ", ").concat(Sa)).forEach(
                            function (t) {
                      ...
                      Tt.trigger(this._scrollElement, wa, { relatedTarget: e });
                  },
                },
                {
                  key: "_clear",
                  ...
                  value: function () {
                    ...
                    (this._element.parentNode &&
                      ...
                      (r = this._element.closest(".nav, .list-group")) &&
                        ((n =
                          "UL" === r.nodeName || "OL" === r.nodeName ? Ja : Za),
                        (e = (e = W.find(n, r))[e.length - 1])),
                      (n = e
                  ...
                  value: function (t, e, n) {
                    ...
                    (e = e && "LI" === e.nodeName ? e.parentNode : e) &&
                      ...
                      ((e = t.closest(".dropdown")) &&
                        W.find(".dropdown-toggle", e).forEach(function (t) {
                ...
                },
                {
                  ...
                  value: function () {
                    this._clearTimeout(),
                      this._element.classList.contains(ns) &&
                        this._element.classList.remove(ns),
                      Fu(qu(o.prototype), "dispose", this).call(this);
                  },
                },
                {
                  key: "_getConfig",
        ...
        A.on(document, "focus", Rs, Hs.activate(new Hs())),
          ...
          A.on(window, "shown.bs.tab", function (t) {
            (t = (
              t.target.href || I.getDataAttribute(t.target, "target")
            ).split("#")[1]),
                ...
                },
                {
                  ...
                  value: function (t) {
                    if (
                      ...
                      for (
                        var e = W.find(ul), n = 0, r = e.length;
                        n < r;
                        n++
                      ) {
                        var o = lt.get(e[n], Gs);
                ...
                },
                {
                  ...
                  value: function (t) {
                    "show" === t
                      ...
                      : (this._menu.classList.add(Bl, Wl),
        ...
        H.find('[data-mdb-toggle="dropdown"]').forEach(function (t) {
          ...
          o(function () {
            ...
            e &&
              ((t = e.fn[xl]),
              (e.fn[xl] = Fl.jQueryInterface),
              (e.fn[xl].Constructor = Fl),
